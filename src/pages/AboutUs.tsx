...
const AboutUs = () => {
  return (
    <>
     <Helmet>
        <title>About SPT Crackers | Sivakasi Crackers City</title>
        <meta name="description" content="Learn about SPT Crackers, your trusted cracker supplier from Sivakasi. Delivering safe and affordable fireworks across India." />
        <meta name="keywords" content="about SPT crackers, sivakasi cracker company, trusted fireworks dealer, crackers city, fireworks brand" />
     ...
     <section className="bg-white py-16 px-6 md:px-20">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
        {/* Left: Text Content */}
        <div>
          <h2 className="text-4xl font-bold mb-6 text-gray-800">About The SPT Crackers</h2>

          <div className="space-y-5 text-gray-600 text-lg leading-relaxed">
            <p>
              SPT Crackers the most trusted and reliable website for online fireworks shopping in India. We are happy to deliver the best quality crackers at lowest prices. We sell different varieties of conventional crackers and fancy novel crackers. Every year, new varieties of crackers are introduced for our online customers. We serve our clients faster and better every time with our 24/7 online support.
            </p>
            <p>
