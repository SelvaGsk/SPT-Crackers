...
const OrderDetailPrint: React.FC<OrderDetailPrintProps> = ({ order, setting }) => {
  ...
  const totalQty =
    order.billProductList?.reduce((acc: number, item: any) => acc + Number(item.qty || 0), 0) || 0;
  ...
  return (
    <div style={{ fontFamily: "Arial", padding: "20px", color: "#000", fontSize: "14px" }}>
      {/* ✅ Store Header */}
      ...
      <table style={{ width: "100%", borderCollapse: "collapse" }}>
        ...
        <tbody>
          ...
          <tr style={{ fontWeight: "bold", backgroundColor: "#fafafa" }}>
            <td colSpan={2} style={tdStyleRight}>Total</td>
      ...
      <p style={{ textAlign: "center", marginTop: "40px" }}>
        Thank you for your purchase! – <strong>SPT Crackers</strong>
      </p>
    </div>
  );
};
